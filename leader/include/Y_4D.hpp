...
Eigen::Matrix<double,2 ,12> calculate_Y_matrix(const Eigen::Vector4d theta, Eigen::Vector4d thetad, Eigen::Vector4d thetadd) {
    ...
    Y(0, 2) = thetadd[2];
    Y(0, 3) = g * sin(theta[2] + theta[0]);
    Y(0, 4) = -g * cos(theta[2] + theta[0]);
    Y(0, 5) = thetadd[0];
    Y(0, 6) = -cos(theta[0]) * g;
    Y(0, 7) = sin(theta[0]) * g;
    Y(0, 8) = tanh(20 * thetad[0]);
    Y(0, 9) = thetad[0];
    Y(0, 10) = 0.0;
    Y(0, 11) = 0.0;
    ...
    Y(1, 3) = g * sin(theta[2] + theta[0]);
    Y(1, 4) = -g * cos(theta[2] + theta[0]);
    Y(1, 5) = 0.0;
    Y(1, 6) = 0.0;
    Y(1, 7) = 0.0;
    Y(1, 8) = 0.0;
    Y(1, 9) = 0.0;
    Y(1, 10) = tanh(20 * thetad[2]);
    Y(1, 11) = thetad[2];
