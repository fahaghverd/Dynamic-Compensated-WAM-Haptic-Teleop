...
file_path_config = args.file_name + "_config"
file_path_jt = args.file_name + "_jt"
...
with open(file_path_config, 'r') as file:
    ...
    for i, line in enumerate(file):
        ...
        # (time, jp_current, jp_desired, jt_sum, gravity, control_jt, dynamics_feed_fwd)
            ...
            jv_desired_2.append(data[7])  # 2nd joint (index 1)
            jv_desired_4.append(data[9])  # 4th joint (index 3)
            jv_current_2.append(data[10])  # 2nd joint (index 1)
            jv_current_4.append(data[12])  # 4th joint (index 3)

            ja_desired_2.append(data[13])  # 2nd joint (index 1)
            ja_desired_4.append(data[15])  # 4th joint (index 3)
            ja_current_2.append(data[16])  # 2nd joint (index 1)
            ja_current_4.append(data[18])  # 4th joint (index 3)
...
with open(file_path_jt, 'r') as file:
    ...
    for i, line in enumerate(file):
        ...
        # (time, jp_current, jp_desired, jt_sum, gravity, control_jt, dynamics_feed_fwd)
            ...
            jt_sum_2.append(data[1])
            jt_sum_4.append(data[3])
            gravity_2.append(data[4])
            gravity_4.append(data[6])
            dynamics_feed_fwd_2.append(data[7])
            dynamics_feed_fwd_4.append(data[9])
            invdyn_2.append(data[10])
            invdyn_4.append(data[12])
