...
with open(file_path, 'r') as file:
    ...
    for i, line in enumerate(file):
        ...
        # (time, jp_current, jp_desired, jt_sum, gravity, control_jt, dynamics_feed_fwd)
            ...
            jv_desired_2.append(data[16])
            jv_desired_4.append(data[18])
            ja_desired_2.append(data[19])
            ja_desired_4.append(data[21])
            # invdyn_2.append(data[22])
            # invdyn_4.append(data[24])
...
print("dynamics_feed_fwd_2 2:", np.mean(dynamics_feed_fwd_2))
