...
template <size_t DOF> int wam_main(int argc, char **argv, ProductManager &pm, systems::Wam<DOF> &wam) {
	...
	systems::TupleGrouper<double, jt_type, jt_type, jt_type> tg_dynamics;
	...
	typedef boost::tuple<double, jt_type, jt_type, jt_type> tuple_type_dynamics;
	...
	//Config File Writing
	configFile << "Master Master Teleop with Gravity Compensation.\n";
